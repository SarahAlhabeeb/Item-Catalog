...
engine = create_engine('sqlite:///applecategory.db?check_same_thread=False',
...
@app.route('/index/')
def showIndex():
    # return "This page will show index page"
...
def editItem(category_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        return render_template(
            ...
            menu_id=menu_id, item=editedItem, category=category)
...
def deleteItem(category_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleteItem.html', menu_id=menu_id,
...
@app.route('/category/<int:category_id>/menu/<int:menu_id>/description')
def showDescription(menu_id, category_id):
    item = session.query(Item).filter_by(
        id=menu_id).all()
    category = session.query(Category).filter_by(id=category_id).one()
    if 'username' not in login_session:
        return render_template('PublicItemDescription.html', category=category,
